...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        self.vtk_text_label.setText("3D Orientation")
        ...
        self.p_90 = (R.from_euler('xyz', [0, 90, 0], degrees=True)).as_matrix()
        self.n_90 = (R.from_euler('xyz', [0, -90, 0], degrees=True)).as_matrix()
    ...
    def coordinate_transform(self):
        ...
        id_88_offset = np.array([0.00, 0.02, -0.11]).reshape(3, 1)
